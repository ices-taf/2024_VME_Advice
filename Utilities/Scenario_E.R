...
# unless the VMEs are isolated c-squares
  ...
  # get vms data
  #vmsreg <- readRDS(paste(pathdir,paste("1-Input data/VMS data repository/All_VMS_datacall",datacallyear_VMS,".rds",sep=""),sep="/"))
  ...
  # fill holes
  tt <- st_union(st_make_valid(st_as_sf(sce23)))
